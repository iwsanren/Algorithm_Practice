...
//    }
    public static TreeNode buildTree() {
        ...
        // 第三层
        TreeNode level3Left1 = new TreeNode(1);
        //TreeNode level3Right1 = new TreeNode(3);
        TreeNode level3Left2 = new TreeNode(5);
        TreeNode level3Right2 = new TreeNode(9);
...
//        TreeNode level4Left2 = new TreeNode(10);
//        TreeNode level4Right2 = new TreeNode(11);
        TreeNode level4Left3 = new TreeNode(4);
        TreeNode level4Right3 = new TreeNode(6);
        TreeNode level4Left4 = new TreeNode(8);
        TreeNode level4Right4 = new TreeNode(10);
